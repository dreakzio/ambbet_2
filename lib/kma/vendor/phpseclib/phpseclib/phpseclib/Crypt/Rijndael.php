    ...
    public function setKey($key)
    {
        switch (mb_strlen($key,"UTF-8")) {
            ...
            case 32:
                break;
            default:
                throw new \LengthException('Key of size ' . mb_strlen($key,"UTF-8") . ' not supported by this algorithm. Only keys of sizes 16, 20, 24, 28 or 32 are supported');
        }

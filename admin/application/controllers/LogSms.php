...
class LogSms extends CI_Controller
{
    ...
    public function log_sms_list_page()
    {
        $get = $this->input->get();
        ...
        $log_count_all = $this->Log_sms_model->log_sms_count();
        $log_count_search = $this->Log_sms_model->log_sms_count($search_data);
        $data = $this->Log_sms_model->log_sms_list($search_data);
        echo json_encode([

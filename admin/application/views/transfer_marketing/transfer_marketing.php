    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">โยกสมาชิกการตลาด</h2>
                                ...
                                <table id="table" class="table dataTables_wrapper dt-bootstrap4  table-hover"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <!-- full_name -->
                                            <th class="text-center">มาจาก user แนะนำ:</th>
...
<script src="<?php echo base_url('assets/scripts/transfer_marketing/transfer_marketing.js?').time() ?>"></script>
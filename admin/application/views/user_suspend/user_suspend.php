...
?>
    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-left mb-0">สมาชิกที่ถูกระงับ</h2>
    ...
    <div class="content-body">
      <section class="card">
        <div class="card-header">
          <h4 class="card-title">รายชื่อสมาชิกที่ถูกระงับ</h4>
        </div>
							  ...
							  <select name="role" id="role" class="form-control">
								  ...
								  <?php foreach (canManageRole()[$_SESSION['user']['role']] as $canManage): ?>
									  <?php if(array_key_exists($canManage,roleDisplay())): ?>
										  <option value="<?php echo $canManage; ?>"><?php echo roleDisplay()[$canManage]; ?></option>
									  <?php endif; ?>
								  <?php endforeach; ?>
							  </select>
							  <?php endif; ?>
  ...
  <script src="<?php echo base_url('assets/scripts/user_suspend/user_suspend.js?').time() ?>"></script>

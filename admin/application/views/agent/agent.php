	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">ระบบจัดการ Agent</h2>
				</div>
			</div>
		</div>
	</div>
	<div class="content-body">
		<section class="card">
			<div class="card-header">
				<h4 class="card-title">รายการ Agent</h4>
			</div>
							...
							<div class="table-responsive">
								...
								<table id="table" class="table dataTables_wrapper dt-bootstrap4  table-hover" style="width:100%">
									...
									<tr>
										...
										<th class="text-center">ยูสภายใต้ทั้งหมด</th>
										<th class="text-center">สรุปฝาก-ถอนยูส</th>
...
<script src="<?php echo base_url('assets/scripts/agent/agent.js?').time() ?>"></script>

...
?>
  <div class="content-wrapper">
    <div class="content-header row">
          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">เพิ่มตำแหน่งการใช้งาน</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <form class="form" id="form_update" method="POST" action="<?php echo site_url("role/role_create") ?>">
					...
					<div class="row ">
					  <div class="col-md-4">
						<div class="form-group">
						  ...
						  <input type="text" id="role_name" name="role_name" class="form-control" value="" placeholder="ข้อมูลชื่อตำแหน่ง">
						</div>
					  </div>
						<div class="col-md-4">
							<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input oninput="validateInputNumber(this)" type="number" id="role_level" name="role_level" class="form-control" value="" placeholder="ข้อมูล Level">
							</div>
						</div>
					</div>
										  ...
										  <?php if($role_id != roleSuperAdmin()): ?>
											  <li class="list-group-item">
												  <div class="form-check">
													  <input class="form-check-input" type="checkbox" value="<?php echo $role_id; ?>" name="role_list[]" id="roleCheck<?php echo $role_id; ?>">
												    ...
												    <?php if($chk_create): ?>
														<li class="list-group-item">
															<div class="form-check ml-2">
																<input class="form-check-input" type="checkbox" value="<?php echo $menu['menu_id']; ?>" name="menu_list[]" id="menuCheck<?php echo $menu['menu_id']; ?>">
...
<script src="<?php echo base_url('assets/scripts/role/role_create.js?t='.time()) ?>"></script>

    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-left mb-0">ระบบจัดการคืนยอดเสีย</h2>
          </div>
        </div>
      </div>
    </div>
    <div class="content-body">
      <section class="card">
        <div class="card-header">
          <h4 class="card-title">รายการคืนยอดเสีย</h4>
        </div>
                  ...
                  <table id="table" class="table dataTables_wrapper dt-bootstrap4  table-hover" style="width:100%">
                    <thead>
                      <tr>
                        ...
                        <th class="text-right">ยอดเล่นเสีย</th>
                        <th class="text-right">Percent จากยอดเล่นเสีย</th>
                        <th class="text-right">Turn (x เท่า)</th>
...
<script src="<?php echo base_url('assets/plugins/moment/min/moment.min.js') ?>"></script>
  ...
  <script src="<?php echo base_url('assets/scripts/bonus/returnbalance.js?'.time()) ?>"></script>

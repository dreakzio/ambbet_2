...
?>
    ...
    <div class="content-body">
      <section class="card">
        <div class="card-content">
          <div class="card-body">
            <form class="form" id="form_update" method="POST" action="<?php echo site_url("news/new_update/{$new['id']}") ?>" enctype="multipart/form-data">
                ...
                <div class="row ">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="name" name="name" class="form-control"  value="<?php echo $new['name']; ?>" placeholder="ข้อมูลชื่อประกาศ">
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="control-label">เรียงลำดับ</label>
                      <input type="number" id="seq" name="seq" class="form-control" value="<?php echo $new['seq']; ?>" placeholder="เรียงลำดับ">
                    </div>
                  </div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">URL</label>
							<input type="text" id="url" name="url" class="form-control" value="<?php echo $new['url']; ?>" placeholder="ข้อมูล URL">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<select class="form-control" name="status_alert" id="status_alert">
								...
								<option value="1" <?php if ($new['status_alert']==1): ?>
									selected
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select class="form-control" name="status_image_alert" id="status_image_alert">
								<option value="0">ปิด</option>
								<option value="1" <?php if ($new['status_image_alert']==1): ?>
									selected
								<?php endif; ?>>เปิด</option>
							</select>
						</div>
                  ...
                  <div class="col-md-12">
                   <fieldset class="form-group">
                     ...
                     <?php if ($new['image_url']): ?>
                       data-title="<?php echo $new['image'] ?>"
                       data-default-file="<?php echo $new['image_url'] ?>"
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="text-right m-b-10">
                      <a type="button" href="<?php echo site_url('new') ?>" class=" btn bg-gradient-warning waves-effect waves-light mr-1"><span><i class="fa fa-arrow-left mr-1"></i></span>ย้อนกลับ</a>
  ...
  <script src="<?php echo base_url('assets/scripts/new/new_update.js?'.time()) ?>"></script>

	...
	<div class="content-body">
		<section class="card">
			<div class="card-header">
				<h4 class="card-title">ยอดฝากรวมรายวัน</h4>
			</div>
							...
							<div class="table-responsive">
								...
								<table id="table" class="table dataTables_wrapper dt-bootstrap4  table-hover" style="width:100%">
									...
									<tr>
										...
										<th class="text-right" >ยอดฝากรวม</th>
									</tr>
									</thead>
									<tbody>
...
<script src="<?php echo base_url('assets/scripts/report/member_register_sum_deposit.js?').time() ?>"></script>

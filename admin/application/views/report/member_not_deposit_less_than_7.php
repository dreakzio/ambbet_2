	...
	<div class="content-body">
		<section class="card">
			<div class="card-header">
				<h4 class="card-title">ไม่ได้ฝากเข้ามามากกว่า 7 วัน</h4>
			</div>
			<div class="card-content">
				<div class="card-body">
						...
						<div class="col-12 col-md-4 pr-1 pl-1">
							<div class="input-group mb-1">
								<div class="input-daterange input-group " id="datepicker">
									<input type="text" class="input-sm form-control d-none"  id="date_start_report" name="start" />
					...
					<div class="row">
						<div class="col-12">
							<h3 class="mt-2 mb-2"><span id="txt_report_date">ระหว่างวันที่</span>&nbsp;:&nbsp;<strong id="txt_report_date_all" class="text-success"></strong></h3>
						</div>
					</div>
							...
							<div class="table-responsive">
								...
								<table id="table" class="table dataTables_wrapper dt-bootstrap4  table-hover" style="width:100%">
									...
									<tr>
										...
										<th class="text-center">กระเป๋า (รอฝาก / Commission / คืนยอดเสีย / แต้มเช็คอิน)</th>
...
<script src="<?php echo base_url('assets/scripts/report/member_not_deposit_less_than_7.js?').time() ?>"></script>

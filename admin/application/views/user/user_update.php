...
<link rel="stylesheet" href="<?php echo base_url('assets/plugins/select2-theme/dist/select2-bootstrap4.css') ?>">
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <form class="form" id="form_update" method="POST" action="<?php echo site_url("user/user_update/{$user['id']}") ?>">
...
<script src="<?php echo base_url('assets/scripts/user/user_update.js?t='.time()) ?>"></script>

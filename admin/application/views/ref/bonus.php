    ...
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-left mb-0">ระบบจัดการโบนัสแนะนำเพื่อน</h2>
          </div>
        </div>
      </div>
    </div>
    <div class="content-body">
      <section class="card">
        <div class="card-header">
          <h4 class="card-title">รายการโบนัสแนะนำเพื่อน</h4>
        </div>
              ...
              <div class="col-12">
                <div class="table-responsive">
                  <table id="table" class="table dataTables_wrapper dt-bootstrap4  table-hover" style="width:100%">
                    <thead>
                      <tr>
                        <th class="text-center">ยูสเล่น</th>
                        <th class="text-right">ยอดเล่น</th>
                        <th class="text-center">ผู้รับโบนัส</th>
                        <th class="text-center">ประเภท</th>
                        <th class="text-right">Percent จากยอดเล่น</th>
                        <th class="text-right">จำนวนเงินสุทธิ</th>
                        <!-- <th class="text-center">Turn ที่ต้องคูณ</th> -->
...
<script src="<?php echo base_url('assets/plugins/moment/min/moment.min.js') ?>"></script>
  ...
  <script src="<?php echo base_url('assets/scripts/ref/ref_deposit.js?'.time()) ?>"></script>

																		...
																		if (!is_null($deposit_min_amount_for_disable_auto) && is_numeric($deposit_min_amount_for_disable_auto) && (float)$deposit_min_amount_for_disable_auto > 0 && (float)$data_insert['amount'] >= (float)$deposit_min_amount_for_disable_auto) {
																			...
																			if(is_numeric($bank_acc)){
																				...
																				if(strlen($bank_acc) >= 10 ){
																					$sql_acc_check = "SELECT id,amount_deposit_auto,bank,bank_number,bank_name,username FROM `account` where username like '%".$bank_acc."%' and deleted = '0' ORDER BY active_deposit_date DESC";
																				}else{
																					...
																					$sql_acc_check = "SELECT id,amount_deposit_auto,bank,bank_number,bank_name,username FROM `account` where ((bank_name like '".$bank_name_like."%') or (username like '%".$bank_acc."%' and bank_name like '".$bank_name_like."%')) and deleted = '0' ORDER BY active_deposit_date DESC";
																				}
